...
# Date: 20201030
# set paths according to out_path key in dictionary
...
class ExternalNode(gpi.NodeAPI):
    ...
    def validate(self):
        ...
        if ( ('File Browser' in self.widgetEvents()) or  ('File Name using out path from dictionary' in self.widgetEvents()) ):
